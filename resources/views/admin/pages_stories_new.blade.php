...
.btn-facebook {
  ...
  background-color: #3b5998;
          ...
          @include('inc.navDashboard')
                    ...
                    <a href="/admin/pages/stories" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">Cancel</a>
                    <div class="row">
                      <div class="col-lg-10 col-xl-7 mx-auto">
                        <div class="card card-signin flex-row my-5">
                          ...
                          <div class="card-body">
                            <h5 class="card-title text-center">Stories</h5>

                            {{-- Form part --}}
                            <form enctype="multipart/form-data" action="/admin/pages/stories/store" method="POST" id="my-form" class="form-signin">
                                {{ csrf_field() }}
                            ...
                            <div class="form-label-group">
                              ...
                              <button class="btn btn-lg btn-primary btn-block text-uppercase" type="submit">Add Stories</button>
                            </form>
                          </div>
                        </div>
                      </div>
